...
<?php echo body_tag(array('id' => @$bodyid, 'class' => @$bodyclass)); ?>
    ...
    <header>
        <h1 id="site-title"> Carleton Guide to Medieval Rome <?php echo link_to_home_page(theme_logo(), array('alt' => 'Carleton Guide to Medieval Rome', 'title' => 'Carleton Guide to Medieval Rome')); ?> </h1>
